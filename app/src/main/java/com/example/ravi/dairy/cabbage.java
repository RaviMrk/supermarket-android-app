...
public class cabbage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cabbage); Intent intent=getIntent();
        final String name=intent.getStringExtra("name");
        final Button btnadd=(Button)findViewById(R.id.cabbageadd);
        final EditText qty=(EditText)findViewById(R.id.cabbageqty);
        btnadd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String name1=name;
                final String prod="cabbage";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(cabbage.this);
                ...
                RequestQueue queue= Volley.newRequestQueue(cabbage.this);
