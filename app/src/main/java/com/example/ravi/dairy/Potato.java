...
public class Potato extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btnadd=(Button)findViewById(R.id.potattoadd);
        final EditText qty=(EditText)findViewById(R.id.poatatoqty);
        btnadd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String name1=name;
                final String prod="potato";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(Potato.this);
                ...
                RequestQueue queue= Volley.newRequestQueue(Potato.this);
